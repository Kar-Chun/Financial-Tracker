    ...
    <Card className="shadow-xs xl:col-span-2">
      ...
      <CardContent>
        {chronological.length === 0 ? (
          ...
          <>
            <div
              className="flex h-52 items-end gap-1.5 rounded-lg bg-linear-to-b from-emerald-50/70 to-transparent px-3 pt-6"
              role="img"
              ...
              {chronological.map((snapshot) => {
                ...
                return (
                  <div key={snapshot.id} className="group relative flex h-full min-w-1 flex-1 items-end">
                    <div className="w-full rounded-t-sm bg-emerald-600/75" style={{ height: `${height}%` }} />
