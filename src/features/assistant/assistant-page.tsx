...
export function AssistantPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-7">
      ...
      <form onSubmit={(event) => { event.preventDefault(); void send(input) }} className="sticky bottom-[calc(var(--mobile-navigation-height)+var(--mobile-navigation-edge-gap)+env(safe-area-inset-bottom)+0.75rem)] z-10 rounded-2xl bg-popover/95 p-2 shadow-xl shadow-black/15 ring-1 ring-white/8 backdrop-blur-xl lg:bottom-4">
